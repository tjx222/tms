...
/*parameter*/
	...
	if($dataoptimize[$pagemark]['parameter']||$search=='search'){
		...
		while($list= $db->fetch_array($result)){
			...
			if(($list['class1']==0) or ($list['class1']==$class1 and $list['class2']==0 and $list['class3']==0) or ($list['class1']==$class1 and $list['class2']==$class2 and $list['class3']==0) or ($list['class1']==$class1 and $list['class2']==$class2 and $list['class3']==$class3)){
				switch($list['module']){
					case 3:
						$product_para[]=$list;
